...
- **Dataset**: Utilizes the MIHIC dataset [MIHIC_dataset](https://zenodo.org/records/10065510)
...
2. Download the MIHIC dataset from here [MIHIC_dataset](https://zenodo.org/records/10065510)

## Usage
1. Run this script to view results: `python visualize_test_images.py`
2. View the output: A plot with 4 segmented images from different classes and a second plot with evaluation metrics.
3. Adjust parameters (e.g., `diameter` in `segment_and_classify`) in the script for better segmentation if needed.
